...
<section class="area_login">
    <div class="login">
        <form action="/cadastro/disciplina/add" method="POST">
            <table>
                <tr>
                    ...
                    <td>
                        <div class="disciplina">
                            <div>
                                <label>Nome:</label><br>
                                <input type="text" name="Nome" id="Nome" required class="text" placeholder="Nome da disciplina">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" name="Quantidade" id="Quantidade" required class="text" placeholder="Quantidade de aulas por semana">
                            </div><br>
                            <div>
